...
public class AssessCoursespiController extends BaseController
{
     ...
     * 查询coursespi列表
     */
    @PreAuthorize("@ss.hasPermi('coursespi:coursespi:list')")
    @GetMapping("/list")
     ...
     * 导出coursespi列表
     */
    @PreAuthorize("@ss.hasPermi('coursespi:coursespi:export')")
     ...
     * 获取coursespi详细信息
     */
    @PreAuthorize("@ss.hasPermi('coursespi:coursespi:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增coursespi
     */
    @PreAuthorize("@ss.hasPermi('coursespi:coursespi:add')")
     ...
     * 修改coursespi
     */
    @PreAuthorize("@ss.hasPermi('coursespi:coursespi:edit')")
     ...
     * 删除coursespi
     */
    @PreAuthorize("@ss.hasPermi('coursespi:coursespi:remove')")
