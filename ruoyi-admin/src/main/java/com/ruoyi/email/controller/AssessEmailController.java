...
public class AssessEmailController extends BaseController
{
     ...
     * 查询email列表
     */
    @PreAuthorize("@ss.hasPermi('email:email:list')")
    @GetMapping("/list")
     ...
     * 导出email列表
     */
    @PreAuthorize("@ss.hasPermi('email:email:export')")
     ...
     * 获取email详细信息
     */
    @PreAuthorize("@ss.hasPermi('email:email:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增email
     */
    @PreAuthorize("@ss.hasPermi('email:email:add')")
     ...
     * 修改email
     */
    @PreAuthorize("@ss.hasPermi('email:email:edit')")
     ...
     * 删除email
     */
    @PreAuthorize("@ss.hasPermi('email:email:remove')")
