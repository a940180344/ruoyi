...
public class AssessXmController extends BaseController
{
     ...
     * 查询xm列表
     */
    @PreAuthorize("@ss.hasPermi('xm:xm:list')")
    @GetMapping("/list")
     ...
     * 导出xm列表
     */
    @PreAuthorize("@ss.hasPermi('xm:xm:export')")
     ...
     * 获取xm详细信息
     */
    @PreAuthorize("@ss.hasPermi('xm:xm:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增xm
     */
    @PreAuthorize("@ss.hasPermi('xm:xm:add')")
     ...
     * 修改xm
     */
    @PreAuthorize("@ss.hasPermi('xm:xm:edit')")
     ...
     * 删除xm
     */
    @PreAuthorize("@ss.hasPermi('xm:xm:remove')")
